...
for indice_lst in lista_bases:
    for indice_fam in lista_fam:
        ...
        for vent in range(4): 
            ...
            Car_df= lda.fit_transform(Car_dff, etiquetas)
            #print(Caracteristicas_vent.shape)    
            #Car_df = pd.DataFrame(Caracteristicas_vent)
...
############3
        ...
        io.savemat('Resultados'+ indice_fam +'_LDA_' + indice_lst + '.mat', {'Resultados': Resultados, 'ResultadosSTD': ResultadosSTD, 
