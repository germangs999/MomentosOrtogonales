...
% Computes Chebyshev polynomials of degree from 0 to N-1 at points 0:1:N-1
...
% The matrix t_hat will be used to store the value of the N polynomials evaluated in
% N different points. The rows of the matrix indicates the point at which
